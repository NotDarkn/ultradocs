<template><div><h1 id="speedrun-tech" tabindex="-1"><a class="header-anchor" href="#speedrun-tech"><span>Speedrun Tech</span></a></h1>
<h2 id="base-movement" tabindex="-1"><a class="header-anchor" href="#base-movement"><span>Base Movement:</span></a></h2>
<p>Slide and Slam Momentum Mechanics
...
Dive Super Slide Jump/Dive Ssj</p>
<p>Wall Super Slide Jump/Wall Ssj</p>
<p>Whip cancel
Punching or whiplashing during whiplash will cancel it, this can be used to make green hook
points function as blue ones
Whip slamming
Slamming during a whiplash will not give downward speed but does build slam momentum</p>
<p>Weapon Movement Tech:
...
Biercer
Holding left click while charging a piercer shot will fire it the instant it full charges</p>
<p>Combat Tech List:
Shotgun Swapping
