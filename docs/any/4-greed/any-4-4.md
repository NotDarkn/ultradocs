...
You can either use a combination of slide jumps to get up to the ramp and ground slam on the bounce pad (Easy), or you can use a [Rocket Push](/speedrun-tech.md#rocket-push) while holding forward (Intermediate) to get to the bounce pad. Once at the top, you can either dash when parallel with the floor or you can ride the cuved ceiling to the blue pedestal, and place the skull.


Once in the main hallway, either [CE boost](/speedrun-tech.md#ce-boost-core-eject-boost) or backwards [Rocket Push](/speedrun-tech.md#rocket-push) and use oil to slide through the door, exampled [here](https://www.youtube.com/watch?v=FL9yqzN7K0A)
<!-- adding video later-->
## V2 Phase 1
